...
window.toggleClass = function(element, className, isShow) {// eslint-disable-line
  element.classList[isShow ? 'add' : 'remove'](className)
}

window.addClass = function(element, className) {// eslint-disable-line
  element && element.classList.add(className)
}

window.removeClass = function(element, className) {// eslint-disable-line
