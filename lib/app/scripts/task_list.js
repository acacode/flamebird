/* global  _ , createButton, global,el, createEl, HotKeys, createSpan, toggleClass, removeClass, addClass */
  ...
  return function(taskListContainer, tasks) {
    ...
    return {
      ...
      getAllFromActiveTab: isRun =>
        isRun
          ? _.filter(taskList[activeTab], { isRun: true })
          : taskList[activeTab],
    }
  }
})()
