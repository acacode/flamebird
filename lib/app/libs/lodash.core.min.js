...
;(function() {
  ...
  function g(n) {
    return typeof n === 'function'
      ? n
      : n == null ? X : (typeof n === 'object' ? d : r)(n)
  }
  function _(n, t) {
    return n < t
  }
  ...
  function N(n) {
    return O(function(t, r) {
      var e = -1,
        u = r.length,
        o = u > 1 ? r[u - 1] : Z,
        o = n.length > 3 && typeof o === 'function' ? (u--, o) : Z
      for (t = Object(t); ++e < u; ) {
        var i = r[e]
        i && n(t, i, e, o)
      }
  ...
  function D(n) {
    var t = []
    if (n != null) for (var r in Object(n)) t.push(r)
    return t
  }
  function I(n, t, r) {
    return (
  ...
  function P(n, t, r) {
    ...
    ;(r = typeof r === 'number' ? (r < 0 ? jn(e + r, 0) : r) : 0),
      (r = (r || 0) - 1)
    for (var u = t === t; ++r < e; ) {
      var o = n[r]
  ...
  function G(n, t) {
    ...
    return (
      (n = Fn(n)),
      function() {
        return --n > 0 && (r = t.apply(this, arguments)), n <= 1 && (t = Z), r
      }
    )
  }
  function J(n, t) {
  ...
  function K(n) {
    return typeof n === 'number' || (H(n) && hn.call(n) == '[object Number]')
  }
  function L(n) {
    return (
      typeof n === 'string' ||
      (!Nn(n) && H(n) && hn.call(n) == '[object String]')
    )
  }
  function Q(n) {
  ...
  var mn = (function(n, t) {
    ...
    An = (function(n) {
      return function(t, r, e) {
        ...
        return (r = n(t, r, e)), r > -1 ? u[o ? t[r] : r] : Z
      }
    })(function(n, t, r) {
      var e = n == null ? 0 : n.length
      if (!e) return -1
      ;(r = r == null ? 0 : Fn(r)), r < 0 && (r = jn(e + r, 0))
      n: {
          ...
          if (c == 'number') {
            if ((c = M(o)))
              var c = o.length,
                ...
                c =
                  !!c &&
                  (f == 'number' || (f != 'symbol' && en.test(i))) &&
                  i > -1 &&
                  i % 1 == 0 &&
                  i < c
          } else c = c == 'string' && i in o
          r = !!c && J(o[i], r)
        } else r = false
      }
      for (r && (u = 1); ++e < u; )
  ...
  ;(o.assignIn = Bn),
    ...
    (o.flattenDeep = function(n) {
      return (n == null ? 0 : n.length) ? p(n, nn) : []
    }),
    (o.iteratee = g),
    (o.keys = Dn),
    (o.map = function(n, t) {
    ...
    (o.slice = function(n, t, r) {
      var e = n == null ? 0 : n.length
      return (r = r === Z ? e : +r), e ? x(n, t == null ? 0 : +t, r) : []
    }),
    ...
    (o.isBoolean = function(n) {
      return (
        n === true || n === false || (H(n) && hn.call(n) == '[object Boolean]')
      )
    }),
    (o.isDate = function(n) {
      return H(n) && hn.call(n) == '[object Date]'
    }),
    ...
    (o.isRegExp = function(n) {
      return H(n) && hn.call(n) == '[object RegExp]'
    }),
    (o.isString = L),
    ...
    (o.result = function(n, t, r) {
      return (
        (t = n == null ? Z : n[t]), t === Z && (t = r), U(t) ? t.call(n) : t
      )
    }),
    (o.size = function(n) {
      return n == null ? 0 : ((n = M(n) ? n : _n(n)), n.length)
    }),
